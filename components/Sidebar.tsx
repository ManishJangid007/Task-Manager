    ...
    <>
      ...
      `}>
        ...
        <div className="!mt-3 mt-auto">
          <a
            href="https://github.com/ManishJangid007"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center px-2 text-[10px] text-muted-foreground/60 hover:text-muted-foreground transition-colors"
          >
            Built by <span className="ml-1">Manish Jangid</span>
          </a>
        </div>
      </aside>
    </>
